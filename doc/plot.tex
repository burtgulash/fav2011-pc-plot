...
\section{Závěr}
Vygenerovaný graf je soubor typu encapsulated postscript (.eps) verze 3. Formát
stránky je landscape letter, stejně jako grafy vygenerované pomocí GNU R, podle
kterého jsem získal inspiraci pro vzhled grafů.
