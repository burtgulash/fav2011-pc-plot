...
Shunting yard algoritmus\cite{wikiShunting}\cite{shewchuk}.
...
hezké a díky použitým metodám i úsporné. Je možné je použít jako doprovodné
obrázky v nástroji \LaTeX.
