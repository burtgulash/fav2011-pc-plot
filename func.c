...
double Log10(double a, double b) { return log10(a); }

double Sin(double a, double b) { return sin(a); }
double Cos(double a, double b) { return cos(a); }
double Tan(double a, double b) { return tan(a); }

double Asin(double a, double b) { return asin(a); }
double Acos(double a, double b) { return acos(a); }
double Atan(double a, double b) { return atan(a); }

double Sinh(double a, double b) { return sinh(a); }
double Cosh(double a, double b) { return cosh(a); }
